...
y_zero_outliers <- which(diamonds$x < 0.1)
...
boxplot(log_price ~ cut, data = equal_carat, main = "log_price grouped by Cut when carat = 0.5")
boxplot(log_price ~ color, data = equal_carat, main = "log_price grouped by Color when carat = 0.5")
boxplot(log_price ~ clarity, data = equal_carat, main = "log_price grouped by Clarity when carat = 0.5")
```
